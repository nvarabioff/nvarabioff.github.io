...
:::{.row style="display: flex; justify-content: center; align-items: center;"}
:::{.column width=10%}
<img alt="Vivid Seats Logo" src="../img/VS-logo.jpg" style="max-width: 100%; height: auto;">
:::
...
:::{.column width=80%}
### Data Engineer
[**Vivid Seats**](https://corporate.vividseats.com/) \
...
:::{.row style="display: flex; justify-content: center; align-items: center;"}
:::{.column width=10%}
<img alt="Hockeyshot Logo" src="../img/hockeyshot-logo.svg" style="max-width: 100%; height: auto;">
:::
...
[**HockeyShot**](https://hockeyshot.ca/) \
_May - August 2021_
:::
:::

<div id="ex2-content" class="collapse">
> _HockeyShot creates hockey training tools including synthetic ice and electronic shooting aids._
...
:::{.row style="display: flex; justify-content: center; align-items: center;"}
:::{.column width=10%}
<img alt="Emtelligent Logo" src="../img/emtelligent-logo.png" style="max-width: 100%; height: auto;">
:::
...
:::{.column width=80%}
### Software Developer (Co-op)
[**emtelligent**](https://emtelligent.com/) \
